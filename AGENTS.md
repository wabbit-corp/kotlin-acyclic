...
- Canonical repo target: `kotlin-acyclic`. Useful entrypoints: `dev project show kotlin-acyclic`, `dev build kotlin-acyclic`, `dev check kotlin-acyclic`.
- Setup-managed files are regenerated with `dev setup kotlin-acyclic`; avoid hand-editing stamped generated files.
