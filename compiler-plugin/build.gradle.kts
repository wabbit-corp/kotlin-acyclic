...
// managed-integrity-v1: 8iyNfVGtPtR
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-acyclic-plugin", project.version.toString())
...
kover {
    ...
    //             // title.set("kotlin-acyclic-plugin Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
plugins.withId("org.jetbrains.dokka") {
    afterEvaluate {
        extensions.findByType(DokkaExtension::class)?.apply {
            moduleName.set("kotlin-acyclic-plugin")
            ...
            dokkaSourceSets.named("main").configure {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-acyclic/tree/master/compiler-plugin/src/main/kotlin")
