...
val generatedVersionSourceDirectory = layout.buildDirectory.dir("generated/sources/acyclicVersion/main/kotlin")

val generateAcyclicGradlePluginVersion by tasks.registering(GenerateAcyclicGradlePluginVersion::class) {
...
tasks {
    ...
    withType<KotlinCompile> {
        dependsOn(generateAcyclicGradlePluginVersion)
        compilerOptions {
