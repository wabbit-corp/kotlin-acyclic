...
// managed-integrity-v1: 4qJSeLnxtu8
//
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            groupId = "one.wabbit"
            artifactId = "kotlin-acyclic-ij-plugin"
...
kover {
    ...
    //             // title.set("kotlin-acyclic-ij-plugin Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
plugins.withId("org.jetbrains.dokka") {
    afterEvaluate {
        extensions.findByType(DokkaExtension::class)?.apply {
            moduleName.set("kotlin-acyclic-ij-plugin")
            ...
            dokkaSourceSets.named("main").configure {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-acyclic/tree/master/ij-plugin/src/main/kotlin")
