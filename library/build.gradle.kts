...
// managed-integrity-v1: RzcgkmsSkVn
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-acyclic", project.version.toString())
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-acyclic"
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-acyclic/tree/master/library/src")
